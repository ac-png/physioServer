...
namespace FlexiCareManager.Controllers
{
    ...
    public class ProgrammesController : BaseController
    {
        ...
        public ProgrammesController(FlexiCareManagerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var programme = await _context.Programme
                .Include(p => p.Exercises.OrderBy(ex => ex.Day))
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Duration,Author")] Programme programme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Duration,Author")] Programme programme)
        {
            if (id != programme.Id)
            {
                return NotFound();
